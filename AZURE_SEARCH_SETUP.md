...
STORAGE_CONTAINER = containermangostmandev01
AOAI_ENDPOINT     = https://mangos-openai.openai.azure.com/
AOAI_API_KEY      = <your-openai-key>
AOAI_EMBED_DEPLOY = textembeddingadamangostm
...
**REST endpoint:** `PUT {SEARCH_ENDPOINT}/datasources/mangos-techm-blob-ds-final?api-version=2024-05-01-preview`

```json
{
  "name": "mangos-techm-blob-ds-final",
  "type": "azureblob",
  "credentials": {
    "connectionString": "<STORAGE_CONN_STR>"
  },
  "container": {
    "name": "containermangostmandev01",
    "query": ""
  },
...
**REST endpoint:** `PUT {SEARCH_ENDPOINT}/indexes/rag-mangostechm-index-final?api-version=2024-05-01-preview`
...
```json
{
  "name": "rag-mangostechm-index-final",
  "fields": [
    {
      "name": "chunk_id",
      "type": "Edm.String",
    ...
    },
    {
      ...
      "facetable": false,
      "dimensions": 1536,
      "vectorSearchProfile": "mangos-hnsw-profile"
    }
  ],
  "similarity": {
  ...
  "vectorSearch": {
    ...
    "profiles": [
      {
        "name": "mangos-hnsw-profile",
        "algorithm": "mangos-hnsw-algo"
      }
    ],
    "vectorizers": [],
    "compressions": []
...
**REST endpoint:** `PUT {SEARCH_ENDPOINT}/skillsets/mangos-techm-skillset-final?api-version=2024-05-01-preview`
...
```json
{
  "name": "mangos-techm-skillset-final",
  ...
  "skills": [
    ...
    },
    {
      ...
      "resourceUri": "https://mangos-openai.openai.azure.com/",
      "apiKey": "<AOAI_API_KEY>",
      "deploymentId": "textembeddingadamangostm",
  ...
  "indexProjections": {
    "selectors": [
      {
        "targetIndexName": "rag-mangostechm-index-final",
...
**REST endpoint:** `PUT {SEARCH_ENDPOINT}/indexers/mangos-techm-indexer-final?api-version=2024-05-01-preview`

```json
{
  "name": "mangos-techm-indexer-final",
  "dataSourceName": "mangos-techm-blob-ds-final",
  "targetIndexName": "rag-mangostechm-index-final",
  "skillsetName": "mangos-techm-skillset-final",
  "parameters": {
    "batchSize": 1,
    "maxFailedItems": -1,
...
**REST endpoint:** `POST {SEARCH_ENDPOINT}/indexers/mangos-techm-indexer-final/run?api-version=2024-05-01-preview`

Check status:

**REST endpoint:** `GET {SEARCH_ENDPOINT}/indexers/mangos-techm-indexer-final/status?api-version=2024-05-01-preview`
...
AZURE_SEARCH_INDEX=rag-mangostechm-index-final
