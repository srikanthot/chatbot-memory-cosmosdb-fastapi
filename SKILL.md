### DATA SOURCE
{
  "name": "mangos-techm-blob-ds-vnext",
  "type": "azureblob",
  "credentials": {
...
{
  "name": "rag-mangostechm-index-vnext",
  "fields": [
    {
      "name": "content_id",
      "type": "Edm.String",
...
{
  "name": "mangos-techm-skillset-vnext",
  ...
  "skills": [
    ...
    },
    {
      ...
      "context": "/document/normalized_images/*",
      "uri": "https://mangos-openai.openai.azure.com/openai/deployments/<GPT41_CHAT_DEPLOYMENT>/chat/completions?api-version=2024-10-21",
      "timeout": "PT1M",
  ...
  "indexProjections": {
    "selectors": [
      {
        "targetIndexName": "rag-mangostechm-index-vnext",
    ...
    "projections": [
      {
        "files": [
          {
            "storageContainer": "mangos-techm-images-vnext",
            "source": "/document/normalized_images/*"
          }
        ]
      }
...
{
  "name": "mangos-techm-indexer-vnext",
  "dataSourceName": "mangos-techm-blob-ds-vnext",
  "targetIndexName": "rag-mangostechm-index-vnext",
  "skillsetName": "mangos-techm-skillset-vnext",
  "parameters": {
    "batchSize": 1,
    "maxFailedItems": -1,
