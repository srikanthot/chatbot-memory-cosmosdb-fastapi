"""MANGOS Tech Manual Agent — Streamlit frontend.
...
# App config
# ---------------------------------------------------------------------------
APP_TITLE = "MANGOS Tech Manual Agent"
APP_VERSION = "v2.0"
...
<div style="background:linear-gradient(135deg,#1e3a5f 0%,#2d5a87 100%);
  ...
  <div style="font-size:0.80rem; color:rgba(255,255,255,0.80);">
    Ask questions against MANGOS technical documentation — answers are grounded in
...
<div style="text-align:center; padding:5rem 2rem 3rem; color:#718096;">
  ...
  <div style="font-size:0.90rem; max-width:460px; margin:0 auto; line-height:1.7;">
    ...
    about MANGOS technical manuals.<br><br>
